...
function statusColor(s?: string) {
    ...
    if (k.includes("fase10") || k.includes("conclu")) return "bg-emerald-600";
    if (k.includes("fase03") || k.includes("prepar")) return "bg-blue-600";
    if (k.includes("fase05") || k.includes("ornam")) return "bg-indigo-600";
    if (k.includes("fase06") || k.includes("pronto")) return "bg-teal-600";
...
export default function PainelTV() {
    ...
    useEffect(() => {
        ...
        const run = async () => {
            ...
            const data = await safeJson<Registro[]>(
    ...
    useEffect(() => {
        ...
        const run = async () => {
            const ctrl = new AbortController();
            const data = await safeJson<Aviso[]>(
