...
const quickActions: QuickAction[] = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M6 19V7a2 2 0 012-2h8a2 2 0 012 2v12" stroke="currentColor" strokeWidth="1.8" />
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <path d="M4 20V9a2 2 0 012-2h12a2 2 0 012 2v11"
          stroke="currentColor" strokeWidth="1.8" />
  ...
  return (
    <div className="min-h-[calc(100vh-1px)] bg-gray-50 dark:bg-gray-950">
      <div className="mx-auto max-w-6xl px-5 py-5">
        ...
        {/* HEADER */}
        <header className="mb-5 flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-end">
          <div>
