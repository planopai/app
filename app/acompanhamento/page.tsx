...
export default function AcompanhamentoPage() {
    ...
    const fetchRegistros = useCallback(() => {
        fetch("https://pai.planoassistencialintegrado.com.br/informativo.php?listar=1&_nocache=" + Date.now(), {
            cache: "no-store",
            headers: {
                Pragma: "no-cache",
                Expires: "0",
    ...
    const enviarRegistroPHP = useCallback((data: any) => {
        ...
        return fetch("https://pai.planoassistencialintegrado.com.br/informativo.php?listar=1&_nocache=", {
            method: "POST",
