...
export default function AcompanhamentoPage() {
    ...
    const fetchRegistros = useCallback(() => {
        fetch("https://app.planoassistencialintegrado.com.br/informativo.php?listar=1&_nocache=" + Date.now(), {
            cache: "no-store",
            headers: {
                Pragma: "no-cache",
                Expires: "0",
    ...
    const fetchAvisos = useCallback(() => {
        fetch("https://app.planoassistencialintegrado.com.br/informativo.php?listar=1&_nocache=" + Date.now(), { credentials: "include" })
            .then((r) => r.json())
    ...
    const enviarRegistroPHP = useCallback((data: any) => {
        ...
        return fetch("https://app.planoassistencialintegrado.com.br/informativo.php?listar=1&_nocache=", {
            method: "POST",
