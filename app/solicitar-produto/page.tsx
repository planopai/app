...
type JustificativaId = "MERCADORIA_REVENDA" | "USO_CONSUMO" | "INSUMOS_ATENDIMENTO";
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="sticky bottom-0 -mx-5 border-t border-slate-200 bg-gray-50/95 p-3 backdrop-blur sm:static sm:mx-0 sm:border-0 sm:bg-transparent sm:p-0">
                            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[1fr_auto]">
                                ...
                                <Button type="button" variant="ghost" onClick={clearForm} disabled={saving} className="w-full sm:w-auto">
                                    Limpar
                                </Button>
                            </div>
                        </div>
